...
export default function SessionDetail() {
  ...
  return (
    <ScrollView className="flex-1 bg-slate-950 p-4">
      ...
      <View className="space-y-3">
        <Pressable className="bg-blue-600 p-4 rounded-xl">
          <Text className="text-white text-center font-bold">Generate QR Code</Text>
        </Pressable>

        <Pressable className="bg-green-600 p-4 rounded-xl">
          <Text className="text-white text-center font-bold">View Attendance</Text>
        </Pressable>

        <Pressable className="bg-slate-700 p-4 rounded-xl border border-slate-600">
          <Text className="text-slate-300 text-center font-bold">Edit Session</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
